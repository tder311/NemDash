...
async def test_db():
    ...
    async with db._pool.acquire() as conn:
        await conn.execute("TRUNCATE dispatch_data, price_data, generator_info, pdpasa_data, stpasa_data, price_setter_data, bid_day_offer, bid_per_offer, predispatch_price, predispatch_interconnector, predispatch_constraint, constraint_equation_terms RESTART IDENTITY CASCADE")
